...
|:-------:|:----------:|:---------|:-----------------------------------------|
| 1.0     | 20/04/2026 | Kawanami | Initial IF->CTRL interface definition.   |
********************************************************************************
*/
...
interface if2ctrl_if;
  ...
  /// Producer
  modport producer(output rs1, output rs2, output csr_raddr);

  /// Consumer
  modport consumer(input rs1, input rs2, input csr_raddr);
